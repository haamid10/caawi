...
const Terms = () => {
  return (
    ...
    <div className=" px-12 py-12 ">
      ...
      <h4 className="font-semibold mb-2 text-md">1. ACCEPTANCE THE USE OF LOREM IPSUM TERMS AND CONDITIONS</h4>
      <p className=" text-sm">
      ...
      <h4 className="font-semibold mb-2 text-sm">2. CREDIT CARD DETAILS</h4>
      <p className=" text-sm">
      ...
      <h4 className="font-semibold mb-2 text-sm">3. LEGAL ADVICE</h4>
      <p className="text-sm">
      ...
      <h4 className="font-semibold mb-2 text-sm">4. CHANGE OF USE</h4>
      <p className="font-semibold mb-2 text-sm">Lorem Ipsum reserves the right to:</p>
      <p className="text-sm">
      ...
      <h4 className="font-semibold mb-2 text-sm">5. LINKS TO THIRD PARTY APPS AND WEBSITES</h4>
      <p className=" text-sm">
      ...
      <h4 className="font-semibold mb-2 text-sm">6. COPYRIGHT</h4>
      <p className="text-sm">
      ...
      <h4 className="font-semibold mb-2 text-sm">7. LINKS TO AND FROM OTHER APPS AND WEBSITES</h4>
      <p className="text-sm">
      ...
      <p className=" text-sm">(b) You do not misrepresent your relationship with this app; and</p>
      <p className="text-sm">
      ...
      <h4 className=" font-bold mb-2 text-sm">8. DISCLAIMERS AND LIMITATION OF LIABILITY</h4>
      <p className="text-sm ">
    ...
    <p className="text-sm">
      ...
      <h4 className="font-bold mb-2 text-sm">9. INDEMNITY</h4>
      <p className="text-sm">
      ...
      <h4 className="font-bold mb-2 text-sm">10. SEVERANCE</h4>
      <p className="text-sm">
      ...
      <h4 className="font-bold mb-2 text-sm">11. WAIVER</h4>
      <p className="text-sm">
      ...
      <h4 className="font-bold mb-2 text-sm">12. GOVERNING LAW</h4>
      <p className="text-sm">
