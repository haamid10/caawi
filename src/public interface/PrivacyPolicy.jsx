...
const PrivacyPolicy = () => {
  return (
    <div>
      ...
      <div className='mt-12 mx-4 p-6'>
      <h1 className='text-2xl  font-bold text-center'>Privacy & Policy </h1>
      <div className="">
      <h4 className=" text-md font-semibold mb-4"> COLLECTION OF INFORMATION</h4>
      ...
      <h4 className="text-md font-semibold mb-4">COOKIE/TRACKING TECHNOLOGY</h4>
      <p className="text-md mb-2">
      ...
      <h4 className="text-md font-semibold mb-4">DISTRIBUTION OF INFORMATION</h4>
      <p className="text-md mb-2">
        We may share information with governmental agencies or other companies
        assisting us in fraud prevention or investigation. We may do so <br/>
        (1) permitted or required by law; or,<br/> (2) trying to protect against or
        prevent actual or potential fraud or unauthorized transactions; or,<br/> (3)
      ...
      <h4 className="text-md font-semibold mb-4">COMMITMENT TO DATA SECURITY</h4>
      <p className="text-md mb-2">
